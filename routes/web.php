...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:perusahaan')->group(function () {
        ...
        Route::get('kuesionerperusahaanstart', [KuesionerPerusahaanController::class, 'index'])->name('kuesioner.perusahaan.index');
        Route::post('kuesionerperusahaan', [KuesionerPerusahaanController::class, 'store'])->name('kuesioner.perusahaan.store');
        Route::get('kuesionerperusahaan/{kuesionerPerusahaan}/edit', [KuesionerPerusahaanController::class, 'edit'])->name('kuesioner.perusahaan.edit');
        Route::put('kuesionerperusahaan/{kuesionerPerusahaan}', [KuesionerPerusahaanController::class, 'update'])->name('kuesioner.perusahaan.update');
        Route::get('kuesionerperusahaan2/{kuesionerPerusahaan}/edit', [KuesionerPerusahaanController::class, 'edit2'])->name('kuesioner.perusahaan.edit2');
        Route::put('kuesionerperusahaan2/{kuesionerPerusahaan}', [KuesionerPerusahaanController::class, 'update2'])->name('kuesioner.perusahaan.update2');
    });
});
