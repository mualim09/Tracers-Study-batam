...
export default function ForgotPassword(props) {
    const { data: people, meta, filtered } = props.users;
    ...
    const reload = useCallback(
        debounce((query) => {
            Inertia.get(
                route('get.nim'),
                {...pickBy(query), page: query.page, load: 5},
                {
                    preserveState: true,
                    preserveScroll: true,
                }
                ...
                <div className="flex items-center justify-end">
                    <div className="flex w-full lg:w-1/2 justify-center lg:justify-end">
                        <div className="flex item-center justify-end gap-x-2 mb-6">
                            <div className='flex items-center gap-x-2 rounded-lg shadow-md bg-white px-2 focus-within:ring-0 transition duration-150 ease-in mt-4 '>
