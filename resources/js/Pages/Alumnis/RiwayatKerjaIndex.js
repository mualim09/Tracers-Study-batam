                                ...
                                {ShowDelete && 
                                    ...
                                    >
                                        <div className='block mb-3 text-sm tracking-tight font-sans p-2 border rounded-md'>
                                            ...
                                            <span className='text-xs md:text-base font-sans'>{dataHistory.bidang}</span>
                                        </div>
                                                ...
                                                <div>
                                                    <table className="flex items-center px-4">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td className='text-gray-700 text-xs md:text-base font-semibold'>Bidang</td>
                                                                <td>:</td>    
                                                                <td className='px-2 py-1 text-gray-800 text-xs md:text-base font-bold'>{dataHistory.bidang}</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
