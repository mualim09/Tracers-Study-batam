            ...
            <div className="px-4 py-5 bg-white sm:p-6">
                <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6 sm:col-span-3">
                        ...
                        { perusahaan ? (
                            <input placeholder='ID Perusahaan' disabled className='w-full bg-gray-100/50 border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-md shadow-sm' type='text' name='identifier' value={data.identifier} handleChange={handleChange}/>
                        ) : (
                            <Input placeholder='ID Perusahaan' className='w-full' type='text' name='identifier' value={data.identifier} handleChange={handleChange}/>
                        ) }
                    ...
                    <div className="col-span-6 sm:col-span-3">
                        ...
                        <Input placeholder='Address' className='w-full' type='text' name='address' value={data.address} handleChange={handleChange}/>
