            ...
            <div className="px-4 py-5 bg-white sm:p-6">
                <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6 sm:col-span-3">
                        ...
                        { alumni ? (
                            <input placeholder='NIM' disabled className='w-full bg-gray-100/50 border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-md shadow-sm' type='text' name='identifier' value={data.identifier} handleChange={handleChange}/>
                        ) : (
                            <Input placeholder='NIM' className='w-full' type='text' name='identifier' value={data.identifier} handleChange={handleChange}/>
                        ) }
                    ...
                    <div className="col-span-6 sm:col-span-3">
                        ...
                        <Input placeholder='Name' className='w-full' type='text' name='name' value={data.name} handleChange={handleChange}/>
                    ...
                    <div className="col-span-6 sm:col-span-3 block items-center">
                        ...
                        <Input placeholder='Email' className="w-full" type='text' name='email' value={data.email} handleChange={handleChange}/>
                    ...
                    <div className="col-span-6 sm:col-span-3">
                        ...
                        { alumni ? (
                            <input placeholder='IPK' disabled className='w-full bg-gray-100/50 border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-md shadow-sm' type='text' name='ipk' value={data.ipk} handleChange={handleChange}/>
                        ) : (
                            <Input placeholder='IPK' className='w-full' type='text' name='ipk' value={data.ipk} handleChange={handleChange}/>
                        ) }
                    ...
                    <div className="col-span-6 sm:col-span-3">
                        ...
                        <Input placeholder='Telp' className='w-full' type='text' name='telp' value={data.telp} handleChange={handleChange}/>
                    ...
                    <div className="col-span-6 sm:col-span-8 lg:col-span-6">
                        ...
                        <div className='flex items-center gap-x-4' onChange={handleChange} value={data.kelamin}>
                            <input className='border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-md shadow-sm text-gray-800' type="radio" value="Laki-laki" name="kelamin" defaultChecked={data.kelamin === 'Laki-laki' && true} /> <span className='block text-gray-700 text-sm text-md tracking-tight font-sans'>Laki-Laki</span>
                            <input className='border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-md shadow-sm text-gray-800' type="radio" value="Perempuan" name="kelamin" defaultChecked={data.kelamin === 'Perempuan' && true} /> <span className='block text-gray-700 text-sm text-md tracking-tight font-sans'>Perempuan</span>
                        </div>
